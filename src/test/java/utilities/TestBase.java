...
public abstract class TestBase {
    ...
    public void setUp() {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));//20 saniyeye kadar bekle. Seleniumdan gelir
        driver.manage().window().maximize();
    }

    public static void driverGet(String a) {
        driver.get(a);
    }
    ...
    public static WebElement findById(String a) {
        return driver.findElement(By.id(a));
    }

    public static WebElement findByClass(String a) {
    ...
    //ve o indexli pencere geçişi yapar
...
//    Bu metot ile belirli bir elemente JS executor ile tiklanabilir
    ...
    // Girmis olunan metni elemente yazdirir
// Bu methos sendKeys() methoduna alternatiftir. sendKeys() oncelikli tercihimizdir.
    public void typeWithJS(WebElement element, String metin) {
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].setAttribute('value','" + metin + "');", element);
    }

//    input elementindeki değerleri al
